    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="-row">
        ...
        <?php foreach ($products as $product) { ?>
          <?php
            // print_r($product['getFilter']);
            if($explode!=""){
            $result = array_diff($explode,$product['getFilter']);
              if(empty($result) && $explode!=""){
            // var_dump(array_intersect($product['getFilter']));
          ?>
              <!-- <div class="product-layout product-list col-xs-12 animate fadeInLeft"> -->
                ...
                <div class="product-thumb" style="padding-bottom:35px;">
                  ...
                  <div>
                    <div class="caption">
                      ...
                      <p class="price" style="font-size:18px;font-weight: bold;">
                        <b>
