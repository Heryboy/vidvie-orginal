          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <img src="" alt="" id="theme" width="200px" class="img-thumbnail" />
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-personalization"><span data-toggle="tooltip" data-container="#tab-general" title="Maximum letter allow to place personalization.">Personalization(Max Length)</span></label>

                <div class="col-sm-10">

                  <input type="text" name="config_personalization" value="<?php echo $config_personalization; ?>" placeholder="Personalization Max Length" id="input-personalization" class="form-control" />
