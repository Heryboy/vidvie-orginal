          ...
          <table id="option-value" class="table table-striped table-bordered table-hover">
            ...
            <thead>
              ...
              <tr>
                ...
                <td class="text-left">Size(Type)</td>
            ...
            <tbody>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                ...
                <td class="text-left">
                  <select class="form-control" name="option_value[<?php echo $option_value_row; ?>][option_size_id]">
                    <?php foreach($optionSizes as $optionSize){ ?>
                    <option <?php if($optionSize['option_size_id']==$option_value['option_size_id']) {echo "selected='selected'";} ?> value="<?php echo $optionSize['option_size_id'];?>"><?php echo $optionSize['name'];?></option>
                    <?php } ?>
                ...
                <td class="text-left">
                  <div class="checkbox">
                    ...
                    <label><input <?php if($option_value['is_instock']==1) echo "checked='checked'"?> type="checkbox" name="option_value[<?php echo $option_value_row; ?>][is_instock]" value="1" id="input-top" /></label>
...
$('select[name=\'type\']').on('change', function() {
	...
	if (this.value == 'select' || this.value == 'box' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'image') {
...
function addOptionValue() {
  ...
  html += '<td class="text-left">';
    html += '<select class="form-control" name="option_value[' + option_value_row + '][option_size_id]">';
    <?php foreach ($optionSizes as $optionSize) { ?>
      
      html += '<option value="<?php echo $optionSize['option_size_id'];?>"><?php echo $optionSize['name'];?></option>';
  ...
  html += '<td>'
    html += '<div class="checkbox">';
      html += '<label><input checked="checked" type="checkbox" name="option_value[' + option_value_row + '][is_instock]" value="1" id="input-top" /></label>';
    html += '</div>';
  html += '</td>';
