        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_photo; ?> <span data-toggle="tooltip" title="Photo Size (1500 x 640) as pixel"></span></label>
                <div class="col-sm-10"><a href="" id="thumb-photo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="image" value="<?php echo $image; ?>" id="input-image" />
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_image; ?> <span data-toggle="tooltip" title="Image Size (413 x 240) as pixel"></span></label>
                <div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $photo_thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="photo" value="<?php echo $photo; ?>" id="input-photo" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="<?php echo $help_is_feature; ?>"><?php echo $entry_is_feature; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($is_feature) { ?>
                      <input type="checkbox" name="is_feature" value="1" checked="checked" id="input-top" />
                      <?php } else { ?>
                      <input type="checkbox" name="is_feature" value="1" id="input-top" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="<?php echo $help_is_store; ?>"><?php echo $entry_is_store; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($is_store) { ?>
                      <input type="checkbox" name="is_store" value="1" checked="checked" id="input-top" />
                      <?php } else { ?>
                      <input type="checkbox" name="is_store" value="1" id="input-top" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
