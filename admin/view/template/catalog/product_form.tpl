          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-text-flag"><?php echo $entry_text_flag; ?></label>

                <div class="col-sm-10">

                  <input type="text" name="text_flag" value="<?php echo $text_flag; ?>" placeholder="<?php echo $entry_text_flag; ?>" id="input-text-flag" class="form-control" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="If check will display symbol sale on sale menu"><?php echo $entry_is_sale; ?></span></label>
                ...
                <div class="col-sm-10">
                  ...
                  <div class="checkbox">
                    ...
                    <label>
                      ...
                      <input type="checkbox" name="is_sale" value="1" checked="checked" id="input-top" />

                      <?php } else { ?>

                      <input type="checkbox" name="is_sale" value="1" id="input-top" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="If check will display symbol sale on sale menu">Is Personalization?</span></label>
                ...
                <div class="col-sm-10">
                  ...
                  <div class="checkbox">
                    ...
                    <label>
                      ...
                      <?php if($is_personalization) { ?>

                      <input type="checkbox" name="is_personalization" value="1" checked="checked" id="input-top" />

                      <?php } else { ?>

                      <input type="checkbox" name="is_personalization" value="1" id="input-top" />
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-available_size"><span data-toggle="tooltip" title="<?php echo $help_available; ?>"><?php echo $entry_available_size; ?></span></label>

                <div class="col-sm-10">

                  <input type="text" name="available_size" value="<?php echo $available_size; ?>" placeholder="<?php echo $entry_available_size; ?>" id="input-available_size" class="form-control" />
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-manufacturer"><span data-toggle="tooltip" title="<?php echo $help_video_url; ?>"><?php echo $entry_video_url; ?></span></label>
                ...
                <div class="col-sm-10">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'box' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') { ?>
                ...
                <table id="discount" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="discount-row<?php echo $discount_row; ?>">
                      ...
                      <td class="text-left" style="width: 10%;"><div class="input-group date">

                          <input type="text" name="product_discount[<?php echo $discount_row; ?>][price_percentage]" value="<?php echo $product_discount['price_percentage']; ?>" placeholder="%" class="form-control" />

                          </div></td>



                      <td class="text-right" style="width: 15%;"><input type="text" name="product_discount[<?php echo $discount_row; ?>][price]" value="<?php echo $product_discount['price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
                ...
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><?php echo $entry_image; ?> <span data-toggle="tooltip" title="Photo Size (960 x 960) as pixel"></span></td>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><?php echo $entry_additional_image; ?> <span data-toggle="tooltip" title="Photo Size (960 x 960) as pixel"></span></td>
...
$('input[name=\'filter-size\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('input[name=\'filter-size\']').val('');

    $('#product-filter-size' + item['value']).remove();

    $('#product-filter-size').append('<div id="product-filter-size' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product_filter_size[]" value="' + item['value'] + '" /></div>');
...
$('#product-filter-size').delegate('.fa-minus-circle', 'click', function() {
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'box' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
...
function addDiscount() {
	...
	html += '  <td class="text-right"><input type="text" name="product_discount[' + discount_row + '][price_percentage]" value="" placeholder="<?php echo $entry_percentage; ?>" class="form-control" /></td>';
