                ...
                <table class="table table-bordered">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <!-- <td class="text-right">Personalization</td> -->
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      ...
                      <!-- <td class="text-right"><?php echo $order_product['personalization']; ?></td> -->
...
$('#button-refresh').on('click', function() {
	...
	$.ajax({
		...
		success: function(json) {
          ...
          // html += '  <td class="text-right">' + product['personalization'] + '</td>';
