...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_personalization'])) {

			$data['config_personalization'] = $this->request->post['config_personalization'];

		} else {

			$data['config_personalization'] = $this->config->get('config_personalization');
	...
	public function theme() {
		...
		if (is_file(DIR_CATALOG . 'view/theme/' . $theme . '/image/' . $theme . '.jpg')) {

			$this->response->setOutput($server . 'catalog/view/theme/' . $theme . '/image/' . $theme . '.jpg');
