...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_is_feature'] = $this->language->get('entry_is_feature');

		$data['entry_is_store'] = $this->language->get('entry_is_store');
		...
		$data['help_is_feature'] = $this->language->get('help_is_feature');

		$data['help_is_store'] = $this->language->get('help_is_store');
		...
		if (isset($this->request->post['photo']) && is_file(DIR_IMAGE . $this->request->post['photo'])) {
			...
			$data['photo_thumb'] = $this->model_tool_image->resize($this->request->post['photo'], 100, 100);

		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['photo'])) {

			$data['photo_thumb'] = $this->model_tool_image->resize($category_info['photo'], 100, 100);

		} else {

			$data['photo_thumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		...
		if (isset($this->request->post['is_feature'])) {

			$data['is_feature'] = $this->request->post['is_feature'];

		} elseif (!empty($category_info)) {

			$data['is_feature'] = $category_info['is_feature'];
		...
		if (isset($this->request->post['is_store'])) {

			$data['is_store'] = $this->request->post['is_store'];

		} elseif (!empty($category_info)) {

			$data['is_store'] = $category_info['is_store'];
